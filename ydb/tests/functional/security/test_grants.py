...
ALTER_TABLE_DROP_COLUMN_GRANTS = ['ydb.granular.alter_schema', 'ydb.granular.describe_schema', 'ydb.granular.remove_schema']
...
ALTER_TABLE_DROP_INDEX_GRANTS = ['ydb.granular.alter_schema', 'ydb.granular.describe_schema', 'ydb.granular.remove_schema']
...
READ_TOPIC_GRANTS = []
ALTER_TABLE_DROP_CHANGEFEED_GRANTS = ['ydb.granular.alter_schema', 'ydb.granular.describe_schema', 'ydb.granular.remove_schema']
